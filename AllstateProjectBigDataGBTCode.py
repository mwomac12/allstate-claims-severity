...
#Create SparkSession and name it AllstateProjectModelGBT

if __name__ == "__main__":
    spark = SparkSession\
        .builder\
        .appName("AllstateProjectModelGBT")\
        .getOrCreate()
...
parameterGrid = ParamGridBuilder() \
    ...
    .addGrid(regressor.maxIter, [10, 100]) \
    .build()
...
#Execution time, start 11:03, finish 11:51 (48 minutes)
